...
welcome.draw_text8x8(40, 15, "Press the button to begin journaling", color565(245,240,240), rotate = 90)
welcome.draw_text8x8(20, 150, " :)", color565(245,240,240), rotate = 90)
