...
class PromptScreen:
    ...
    def showAM():
        ...
        prompt = DisplayManager.display 

        chosen_prompt = random.choice(PromptScreen.am_prompts) #type: str
        ...
        for line in wrapped_prompt:
            ...
            prompt.draw_text8x8(x_coordinate, y_coordinate, line, color565(245,240,240), rotate = 90)
            x_coordinate -= 15
    ...
    def showPM():
        ...
        chosen_prompt = random.choice(PromptScreen.pm_prompts) #type: str
